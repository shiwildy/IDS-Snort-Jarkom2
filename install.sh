...
apt install build-essential cmake libpcap-dev libpcre3-dev zlib1g-dev libluajit-5.1-dev libssl-dev automake libtool autoconf pkg-config git tshark net-tools -y
